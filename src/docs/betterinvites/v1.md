...
<span class="px-3 py-1 rounded-full bg-red-600 text-white text-xs select-none">Outdated</span> 

> ⚠️ **Notes**
> <br>
> 🗑 **This bot is deprecated.** Please use [BetterInvites v2](https://thymedev.github.io/invite/betterinvites) instead.
